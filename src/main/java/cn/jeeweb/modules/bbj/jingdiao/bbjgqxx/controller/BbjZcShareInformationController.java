package cn.jeeweb.modules.bbj.jingdiao.bbjgqxx.controller;
 ...
 */
@Controller
@RequestMapping("${admin.url.prefix}/bbjgqxx/bbjzcshareinformation")
@RequiresPathPermission("bbjgqxx:bbjzcshareinformation")
