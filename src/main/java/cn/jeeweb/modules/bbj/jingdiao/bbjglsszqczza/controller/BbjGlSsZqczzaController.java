package cn.jeeweb.modules.bbj.jingdiao.bbjglsszqczza.controller;
...
import cn.jeeweb.modules.bbj.jingdiao.bbjglsszqczza.entity.BbjGlSsZqczza;
import cn.jeeweb.modules.bbj.jingdiao.bbjglsszqczza.service.IBbjGlSsZqczzaService;

/**   
 * @Title: 诉讼_债权处置障碍
 * @Description: 诉讼_债权处置障碍
 * @author somuns
 * @date 2018-01-24 23:11:55
 * @version V1.0   
 *
 */
@Controller
@RequestMapping("${admin.url.prefix}/bbjglsszqczza/bbjglsszqczza")
@RequiresPathPermission("bbjglsszqczza:bbjglsszqczza")
