package cn.jeeweb.modules.bbj.jingdiao.bbjzcczza.controller;
...
import cn.jeeweb.modules.bbj.jingdiao.bbjzcczza.entity.BbjZcAssetDisposal;
import cn.jeeweb.modules.bbj.jingdiao.bbjzcczza.service.IBbjZcAssetDisposalService;

/**   
 * @Title: 资产处置障碍
 * @Description: 资产处置障碍
 * @author somuns
 * @date 2018-01-28 14:12:04
 * @version V1.0   
 *
 */
@Controller
@RequestMapping("${admin.url.prefix}/bbjzcczza/bbjzcassetdisposal")
@RequiresPathPermission("bbjzcczza:bbjzcassetdisposal")
