package cn.jeeweb.modules.bbj.bbjglmortgageothers.controller;
 ...
 */
@Controller
@RequestMapping("${admin.url.prefix}/bbjglmortgageothers/bbjglmortgageothers")
@RequiresPathPermission("bbjglmortgageothers:bbjglmortgageothers")
