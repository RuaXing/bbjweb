...
<body title="资产处置障碍">
<grid:grid id="bbjZcAssetDisposalGridId" url="${adminPath}/bbjzcczza/bbjzcassetdisposal/ajaxList">
	<grid:column label="sys.common.key" hidden="true"   name="id" width="100"/>
    <grid:column label="资产"  name="assets" />
    <grid:column label="类型"  name="type"  query="true"  queryMode="select"  condition="eq"  dict="zcxz"/>
