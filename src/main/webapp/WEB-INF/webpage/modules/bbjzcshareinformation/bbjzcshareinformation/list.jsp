...
<body title="股权信息">
<grid:grid id="bbjZcShareInformationGridId" url="${adminPath}/bbjzcshareinformation/bbjzcshareinformation/ajaxList">
    ...
    <grid:column label="经营范围"  name="businessScope"  query="true"  queryMode="select"  condition="eq"  dict="sex"/>
    <grid:column label="查封顺序"  name="attachmentOrder"  query="true"  queryMode="select"  condition="eq"  dict="sex"/>
