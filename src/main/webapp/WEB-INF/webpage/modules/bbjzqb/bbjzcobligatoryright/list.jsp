...
<body title="债权表">
<grid:grid id="bbjZcObligatoryRightGridId" url="${adminPath}/bbjzqb/bbjzcobligatoryright/ajaxList">
    ...
    <grid:column label="授信类型"  name="creditType"  query="true"  queryMode="select"  condition="eq"  dict="bbjsxlx"/>
    ...
    <grid:column label="诉讼阶段"  name="litigationStage"  query="true"  queryMode="select"  condition="eq"  dict="bbjsujd"/>
    <grid:column label="抵/质押物查封顺序"  name="pledgeSequence"  query="true"  queryMode="select"  condition="eq"  dict="cfsw"/>
    ...
    <grid:column label="拟处置方式"  name="quasiDisposalMode"  query="true"  queryMode="select"  condition="eq"  dict="bbjczfs"/>
